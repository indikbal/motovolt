$(function () {
    ...
    sideMenu.append('<div class="mobile_menu_header"><img class="mobile_menu_logo" src="img/white-lgoo.png"/><button class="close"> <img src="img/menu-close.png" /></button></div>')
